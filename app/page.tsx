        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold opacity-70 mt-0.5">Soy nuevo en el club</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold text-white/50 mt-0.5">Ya soy miembro del club</p>
            </div>
          </button>
        </div>
